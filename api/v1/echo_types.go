...
type EchoStatus struct {
	...
	// conditions represent the current state of the Echo resource.
...
type Echo struct {
	...
	// spec defines the desired state of Echo
	// +required
	Spec EchoSpec `json:"spec"`

	// status defines the observed state of Echo
	// +optional
	Status EchoStatus `json:"status,omitzero"`
}
...
func init() {
	SchemeBuilder.Register(func(s *runtime.Scheme) error {
		s.AddKnownTypes(SchemeGroupVersion, &Echo{}, &EchoList{})
		return nil
	})
}
